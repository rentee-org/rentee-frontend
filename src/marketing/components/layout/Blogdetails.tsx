            ...
            <div className="mt-8 flex items-start justify-between gap-5">
              ...
              <div className='w-full bg-white p-4 rounded-lg shadow-md'>
                <p className='py-2'>
                    ...
                    and ultimately generating code for a given target.Intermediate representations(IRsfor short) are a key 
                    ingredient in almost any modern compiler. IRs help represent programs in a structured and simplified way so 
                    as to make analyses and optimizations easier. In this blog post, well delve into Codons intermediate 
                ...
                <p className='py-4'>
                    ...
                    generating code for a given target.Intermediate representations(IRsfor short) are a key ingredient in 
                    almost any modern compiler. IRs help represent programs in a structured and simplified way so as to make analyses 
                    and optimizations easier. In this blog post, well delve intoCodons intermediate representation—Codon 
                ...
                <p className='py-4'>Compilers are complex pieces of software that involve many stages, 
                    from parsing code to type checking to performing analyses and transformations,
                    and ultimately generating code for a given target.Intermediate representations(IRsfor short) 
                    are a key ingredient in almost any modern compiler. IRs help represent programs in a structured 
                    and simplified way so as to make analyses and optimizations easier. In this blog post, well delve 
                    intoCodons intermediate representation—Codon IR—including why we created it, how it works, what it 
