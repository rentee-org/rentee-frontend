  ...
  return (
    ...
    <div className="flex flex-col items-center justify-between gap-12 px-6 md:px-16 py-20 w-full bg-gray-50  m-auto">
      <div className=" flex flex-row items-center justify-between gap-4 px-6 md:px-20 py-8 max-w-7xl mx-auto w-full">
        <div>
          {" "}
          <h4 className="text-4xl md:text-5xl font-semibold mb-4 text-gray-800 text-center font-avenir">
            {" "}
            Browser Listing{" "}
          </h4>
        </div>
        <div>
          ...
          <button
            type="submit"
            className="px-6 py-2 rounded-sm bg-white-600  text-[#5400e6] border-2 font-avenir"
          >
            See All Category
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  px-6 md:px-10 py-8  mx-auto max-w-7xl gap-5">
        {Data.map((Product: ProductItems) => (
          <div
            key={Product.id}
            className="flex flex-col items-center justify-center  border-2 border-gray-50  h-full w-70 shadow-md rounded-sm "
          >
            <img src={Product.img} alt="" className="h-35 w-full" />
            <div className="py-4 px-3">
             ...
             <div className="flex items-start justify-between gap-2 mt-4 mb-4">
               ...
               {User.map((user: UserProfile) => (
                <div key={user.id} className="flex flex-row items-center justify-between gap-12">
...
export interface ProductItems {
  ...
  name: string;
  description: string;
>>>>>>> 99d945c (fix: improve navbar layout and icon placement)
}
